...
if __name__ == '__main__':
    if len(argv) != 3:
        print('usage: python netassay_python3.py pcap_directory out_directory')
        exit(-1)
    ...
    for thisf in files:
        ...
        filename = thisf.split("/")[-1]
        out_filename = filename + "output.p"
        outFile = open(output_dir + out_filename, 'wb')
        ethPacketList = []
