...
if __name__ == '__main__':
    if len(argv) != 4:
        print('usage: python netassay_python3_p4sim.py allowed_dns_dst.txt banned_dns_dst.txt outfilename')
        exit(-1)
    
    # Parse allowed IP and banned IP files
    allowed_ip_file = open(argv[1], 'r')
