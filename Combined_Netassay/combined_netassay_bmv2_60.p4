...
control TopIngress(inout Parsed_packet headers,
    ...
    // REGISTER ARRAY FOR KEEPING TRACK OF OVERFLOW DNS RESPONSES or TLS CLIENT HELLOS
    ...
    apply {
        ...
        else if (user_metadata.is_ip == 1 && user_metadata.is_dns == 0 && user_metadata.is_clienthello == 0) {
